...
def scanFunc(process, pattern, isCall):
    ...
    # Rebase and return the address in hex format.
    return hex(address - process.base_address)
...
try:
    ...
    # Find functions.
    print("get_scheduler ", scanFunc(process, b"\\xE8....\\x8D\\x7E\\x68", True))
    print("get_state     ", scanFunc(process, b"\\xE8....\\x8B\\xF0\\x8D\\x8D\\xA8\\xFD\\xFF\\xFF", True))
    print("luavm_load    ", scanFunc(process, b"\\xE8....\\x8B\\xD0\\x64\\xA1", True))
    print("task_spawn    ", scanFunc(process, b"\\x55\\x8B\\xEC\\x6A\\xFF\\x68....\\x64\\xA1\\x00\\x00\\x00\\x00\\x50\\x83\\xEC.\\xA1....\\x33\\xC5\\x89\\x45\\xEC\\x56\\x57\\x50\\x8D\\x45\\xF4\\x64\\xA3\\x00\\x00\\x00\\x00\\x8B\\x75.\\xC7\\x45\\xE8", False))
    print("print         ", scanFunc(process, b"\\xE8....\\x0F\\xBF\\x45\\xF8", True))
